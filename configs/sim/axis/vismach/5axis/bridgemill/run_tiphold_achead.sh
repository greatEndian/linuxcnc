#!/bin/bash
# Headless live-sim tip-hold validation for the ACHEAD G43.5 topology.
# Launches the achead-hl.ini sim (5axiskins sparm=tiltA), drives it via
...
SAMPLES="${TMPDIR:-/tmp}/achead_samples.txt"
RSH_LOG="${TMPDIR:-/tmp}/achead_rsh.txt"
