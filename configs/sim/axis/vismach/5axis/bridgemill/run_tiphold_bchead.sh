#!/bin/bash
# Headless live-sim tip-hold validation for the BCHEAD G43.5 topology.
# Launches the bchead-hl.ini sim (5axiskins sparm=tiltA), drives it via
...
SAMPLES="${TMPDIR:-/tmp}/bchead_samples.txt"
RSH_LOG="${TMPDIR:-/tmp}/bchead_rsh.txt"
